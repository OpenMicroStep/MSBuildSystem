...
export type Extension    <T, A0> = (Validator <T, A0> | ValidatorNU <T | undefined, A0>) & { doc?: string };
export type Extension0   <T    > = (Validator0<T    > | ValidatorNU0<T | undefined    >) & { doc?: string };
