...
GCC.prototype.compile = function(runner, srcFile, lang, objFile, options, callback) {
  var args = [];
...
GCC.prototype.link = function(objFiles, finalFile, options, callback) {
  ...
  args.push("-o", finalFile.path, "-Wl,--export-all-symbols", "-Wl,--allow-multiple-definition", "-static-libgcc", "-static-libstdc++");
